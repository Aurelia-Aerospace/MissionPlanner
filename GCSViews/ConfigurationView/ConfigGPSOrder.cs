...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigGPSOrder : MyUserControl, IActivate
    {
        ...
        public void Activate()
        {
            ...
            if (id1ovr.Value != 0)
                list.Add(new GPSCAN() {Order = 1, NodeID = (int) id1ovr.Value, Name = Strings.GPSOverride1});
            if (id2ovr.Value != 0)
                list.Add(new GPSCAN() {Order = 2, NodeID = (int) id2ovr.Value, Name = Strings.GPSOverride2});
            if (id1.Value != 0 && id1.Value != id1ovr.Value && id1.Value != id2ovr.Value)
                list.Add(new GPSCAN() {Order = 98, NodeID = (int) id1.Value, Name = Strings.GPSDetect1});
            if (id2.Value != 0 && id2.Value != id1ovr.Value && id2.Value != id2ovr.Value)
                list.Add(new GPSCAN() {Order = 99, NodeID = (int) id2.Value, Name = Strings.GPSDetect2});
